# Workflow tools and useful websites
...
## IP and domain context

- [WhatIsMyIPAddress](https://whatismyipaddress.com/)
- Use the organization's approved threat-intelligence platform when available.

## URL, file, and hash analysis
...
- [Microsoft Kusto Query Language documentation](https://learn.microsoft.com/en-us/kusto/query/)
- [Azure Monitor table reference](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables-index)
- [Must Learn KQL](https://rodtrent.substack.com/p/must-learn-kql-part-1-tools-and-resources)

## Current cybersecurity reporting
